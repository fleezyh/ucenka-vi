    ...
    koren.innerHTML = `
      <div class="fs">
        ...
        <footer class="fs__foot">
          ${vidy.includes("факт") ? "<p><b>Факт</b> — бухгалтерская выгрузка «Анализ ЗП», ФОТ итого: с отпускными, больничными и квартальными премиями, поэтому он выше прогноза: прогноз знает оклады, плановые премии и отпускные по датам отпусков из 1С, но не больничные и не квартальные премии.</p>" : ""}
