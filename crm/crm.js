/* CRM продаж: доска как рабочее место — метки, «Сегодня», следующий шаг на
 * карточке, панель «Связь» с почтой и Мессенджером. Основная с 23.09.2026
 * (до этого — тестовая в /crm/test/); прежняя версия лежит в /crm/staraya/.
 *
