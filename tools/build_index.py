...
# Габариты и вес добавлены в конец по той же причине, по какой «Код сайта» стоял
# последним: позиции прежних полей не двигаются, а старый шард без них просто
# короче — сайт читает по индексу и не спотыкается.
